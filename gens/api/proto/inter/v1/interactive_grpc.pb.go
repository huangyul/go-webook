...
// - protoc             (unknown)
// source: api/proto/inter/v1/interactive.proto
...
const (
	InteractiveService_IncrReadCnt_FullMethodName = "/inter.v1.InteractiveService/IncrReadCnt"
	InteractiveService_Like_FullMethodName        = "/inter.v1.InteractiveService/Like"
	InteractiveService_CancelLike_FullMethodName  = "/inter.v1.InteractiveService/CancelLike"
	InteractiveService_Collect_FullMethodName     = "/inter.v1.InteractiveService/Collect"
	InteractiveService_Get_FullMethodName         = "/inter.v1.InteractiveService/Get"
)
...
type InteractiveServiceClient interface {
	IncrReadCnt(ctx context.Context, in *IncrReadCntRequest, opts ...grpc.CallOption) (*EmptyResponse, error)
	Like(ctx context.Context, in *LikeRequest, opts ...grpc.CallOption) (*EmptyResponse, error)
	CancelLike(ctx context.Context, in *CancelLikeRequest, opts ...grpc.CallOption) (*EmptyResponse, error)
	Collect(ctx context.Context, in *CollectRequest, opts ...grpc.CallOption) (*EmptyResponse, error)
	Get(ctx context.Context, in *GetRequest, opts ...grpc.CallOption) (*InteractiveResponse, error)
}
...
func (c *interactiveServiceClient) IncrReadCnt(ctx context.Context, in *IncrReadCntRequest, opts ...grpc.CallOption) (*EmptyResponse, error) {
...
func (c *interactiveServiceClient) Like(ctx context.Context, in *LikeRequest, opts ...grpc.CallOption) (*EmptyResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(EmptyResponse)
...
func (c *interactiveServiceClient) CancelLike(ctx context.Context, in *CancelLikeRequest, opts ...grpc.CallOption) (*EmptyResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(EmptyResponse)
...
func (c *interactiveServiceClient) Collect(ctx context.Context, in *CollectRequest, opts ...grpc.CallOption) (*EmptyResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(EmptyResponse)
...
func (c *interactiveServiceClient) Get(ctx context.Context, in *GetRequest, opts ...grpc.CallOption) (*InteractiveResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(InteractiveResponse)
...
type InteractiveServiceServer interface {
	IncrReadCnt(context.Context, *IncrReadCntRequest) (*EmptyResponse, error)
	Like(context.Context, *LikeRequest) (*EmptyResponse, error)
	CancelLike(context.Context, *CancelLikeRequest) (*EmptyResponse, error)
	Collect(context.Context, *CollectRequest) (*EmptyResponse, error)
	Get(context.Context, *GetRequest) (*InteractiveResponse, error)
...
func (UnimplementedInteractiveServiceServer) IncrReadCnt(context.Context, *IncrReadCntRequest) (*EmptyResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method IncrReadCnt not implemented")
}
func (UnimplementedInteractiveServiceServer) Like(context.Context, *LikeRequest) (*EmptyResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Like not implemented")
}
func (UnimplementedInteractiveServiceServer) CancelLike(context.Context, *CancelLikeRequest) (*EmptyResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CancelLike not implemented")
}
func (UnimplementedInteractiveServiceServer) Collect(context.Context, *CollectRequest) (*EmptyResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Collect not implemented")
}
func (UnimplementedInteractiveServiceServer) Get(context.Context, *GetRequest) (*InteractiveResponse, error) {
...
var InteractiveService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "inter.v1.InteractiveService",
	...
	Metadata: "api/proto/inter/v1/interactive.proto",
}
