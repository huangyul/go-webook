...
import (
	...
	"github.com/huangyul/go-webook/comment/domain"
	"github.com/huangyul/go-webook/comment/repository/dao"
...
func NewCommentRepo(commentDAO dao.CommentDAO) CommentRepository {
