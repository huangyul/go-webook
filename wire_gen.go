...
func InitApp() *App {
	...
	rankingService := service.NewRankingService(interactiveServiceClient, articleService, rankingRepository)
	articleHandler := web.NewArticleHandler(articleService, interactiveServiceClient, historyService, rankingService)
