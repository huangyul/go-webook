...
const file_intr_v1_intr_proto_rawDesc = "" +
	...
	"\x13IncrReadCntResponse\"M\n" +
	"\vLikeRequest\x12\x10\n" +
	"\x03biz\x18\x01 \x01(\tR\x03biz\x12\x14\n" +
	"\x05bizId\x18\x02 \x01(\x03R\x05bizId\x12\x16\n" +
	"\x06userId\x18\x03 \x01(\x03R\x06userId\"\x0e\n" +
	"\fLikeResponse\"S\n" +
	"\x11CancelLikeRequest\x12\x10\n" +
	"\x03biz\x18\x01 \x01(\tR\x03biz\x12\x14\n" +
	"\x05bizId\x18\x02 \x01(\x03R\x05bizId\x12\x16\n" +
	"\x06userId\x18\x03 \x01(\x03R\x06userId\"\x14\n" +
	"\x12CancelLikeResponse\"P\n" +
	"\x0eCollectRequest\x12\x10\n" +
	"\x03biz\x18\x01 \x01(\tR\x03biz\x12\x14\n" +
	"\x05bizId\x18\x02 \x01(\x03R\x05bizId\x12\x16\n" +
	"\x06userId\x18\x03 \x01(\x03R\x06userId\"\x11\n" +
	"\x0fCollectResponse\"V\n" +
	"\x14CancelCollectRequest\x12\x10\n" +
	"\x03biz\x18\x01 \x01(\tR\x03biz\x12\x14\n" +
	"\x05bizId\x18\x02 \x01(\x03R\x05bizId\x12\x16\n" +
	"\x06userId\x18\x03 \x01(\x03R\x06userId\"\x17\n" +
	"\x15CancelCollectResponse\"L\n" +
	"\n" +
	"GetRequest\x12\x10\n" +
	"\x03biz\x18\x01 \x01(\tR\x03biz\x12\x14\n" +
	"\x05bizId\x18\x02 \x01(\x03R\x05bizId\x12\x16\n" +
	...
	"\x05value\x18\x02 \x01(\v2\x14.intr.v1.InteractiveR\x05value:\x028\x012\xdb\x03\n" +
	...
	"\bGetByIds\x12\x18.intr.v1.GetByIdsRequest\x1a\x19.intr.v1.GetByIdsResponseB\x90\x01\n" +
	"\vcom.intr.v1B\tIntrProtoP\x01Z9github.com/huangyul/buf-demo/api/proto/gen/intr/v1;intrv1\xa2\x02\x03IXX\xaa\x02\aIntr.V1\xca\x02\aIntr\\V1\xe2\x02\x13Intr\\V1\\GPBMetadata\xea\x02\bIntr::V1b\x06proto3"
